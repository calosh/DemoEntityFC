...
{
    [DbContext(typeof(PruebaEntityDbContext))]
    partial class PruebaEntityDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PruebaEntity.App.Productos.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PruebaEntity.App.Productos.Nivel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PruebaEntity.App.Productos.Producto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PruebaEntity.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PruebaEntity.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PruebaEntity.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("PruebaEntity.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("PruebaEntity.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("CategoriaProducto", b =>
                {
                    b.HasOne("PruebaEntity.App.Productos.Categoria", null)
                        .WithMany()
                        .HasForeignKey("CategoriasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PruebaEntity.App.Productos.Producto", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PruebaEntity.App.Productos.Categoria", b =>
                {
                    b.HasOne("PruebaEntity.App.Productos.Nivel", "Nivel")
                        .WithMany()
            ...
            modelBuilder.Entity("PruebaEntity.Authorization.Roles.Role", b =>
                {
                    b.HasOne("PruebaEntity.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("PruebaEntity.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("PruebaEntity.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
