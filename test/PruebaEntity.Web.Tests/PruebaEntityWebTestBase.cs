...
{
    public abstract class PruebaEntityWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PruebaEntityWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PruebaEntityWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PruebaEntityDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PruebaEntityDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PruebaEntityDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PruebaEntityDbContext, Task<T>> func)
        {
            T result;
